...
if (submitFeedback) {
  submitFeedback.onclick = async function(e) {
    ...
    const proxyUrl = "https://se-git-main-salehs-projects-ffe71019.vercel.app/submit"; // استبدل هذا برابط الخادم الوسيط (مثل https://your-vercel-app.vercel.app/submit)
    const formData = {
